...
import CourseInformation from "../Admin/CreateCourse/CourseInformation";
import CourseData from "../Admin/CreateCourse/CourseData";
import CourseContent from "../Admin/CreateCourse/CourseContent";
import CoursePreview from "../Admin/CreateCourse/CoursePreview";
import CourseOptions from "../Admin/CreateCourse/CourseOptions";
...
const EditCourse: React.FC<Props> = ({ id }) => {
  ...
  const editCourseData =
    data && data.course.find((item: any) => item._id === id);
  ...
  useEffect(() => {
    if (editCourseData) {
      ...
      setPrerequisite(editCourseData?.prerequisite);
